...
const Footer = () => {
	return (
		<footer class="bg-black text-white">
			<div class="mx-auto w-full max-w-screen-xl p-4 py-16 lg:py-8">
					...
					<div class="grid grid-cols-2 gap-20 sm:gap-6 sm:grid-cols-3">
						...
						<div className="w-2/10">
							<ul class="text-gray-500 font-semibold cursor-pointer">
								<li class="mb-4  hover:font-bold hover:text-PGreen hover:scale-95 transition-all duration-200">
									<Link to={`/blog`}>Maytra Blog</Link>
								</li>
								<li class="mb-4 cursor-pointer hover:font-bold hover:scale-95 hover:text-PGreen transition-all duration-200">
									Expo, Awards, & Events
								</li>
								<li class="mb-4 cursor-pointer hover:font-bold hover:scale-95 hover:text-PGreen transition-all duration-200">
